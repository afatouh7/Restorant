...
{ 
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (cart != null)
            {
                detailCart.ShoppingCart = cart.ToList();
            }

            foreach (var list in detailCart.ShoppingCart)
            {
        ...
        public async Task<IActionResult> SummaryPost(string stripeToken)
        {
            ...
            detailCart.ShoppingCart = await _db.ShoppingCart.Where(c => c.ApplicationUserId == claim.Value).ToListAsync();
            ...
            _db.ShoppingCart.RemoveRange(detailCart.ShoppingCart);
